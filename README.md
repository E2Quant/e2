...
E2L 使用 C++ 开发的一种策略性语言，它基于 LLVM IR( *目前测试兼容 llvm-14, llvm-18*,llvm-20* ) 基本架构, [ FLEX 词汇分析器生成器](https://westes.github.io/flex/manual/index.html#SEC_Contents) 及 [ GNU BISON (YACC) 通用的解析器生成器 ](https://www.gnu.org/software/bison/) 作为语法分析. 主要功能是价格的计算, 即数学的运算为主的一种简单性的编程语言. [详细说明请参考 E2L 文档](https://e2q-doc.readthedocs.io/e2l/)
